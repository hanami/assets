...
gem 'hanami-emberjs',        path: 'spec/fixtures/hanami-emberjs',        require: false
gem 'hanami-compass',        path: 'spec/fixtures/hanami-compass',        require: false
gem 'hanami-foo-compressor', path: 'spec/fixtures/hanami-foo-compressor', require: false
